...
public class LoginActivity extends AppCompatActivity {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            RestManager.getInstance().login(email, password, new PholumeCallback<User>("login") {
                @Override
                public void onResponse(Call<User> call, Response<User> response) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        loginFailed(String.valueOf(response.code()), response.message());
                    }
                }
                ...
                public void onFailure(Call<User> call, Throwable t) {
                    t.printStackTrace();
                    loginFailed("Login Failed", t.getMessage());
                }
            });
        }
    }
    ...
    private void loginFailed(String errorTitle, String message) {
        showProgress(false);
